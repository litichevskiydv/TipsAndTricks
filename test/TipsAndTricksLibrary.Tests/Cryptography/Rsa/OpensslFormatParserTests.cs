namespace TipsAndTricksLibrary.Tests.Cryptography.Rsa
{
    ...
    public class OpensslFormatParserTests
    {
        ...
        [UsedImplicitly]
        public static IEnumerable<object[]> ParsePrivateKeyFromStringTestsData;
        ...
        [Theory]
        [MemberData(nameof(ParsePrivateKeyFromStringTestsData))]
        public void ShouldReadKeyFromString(string key, RSAParameters expected)
        {
            // When
            var actual = _parser.ParsePrivateKey(key);
